...
public class TitlePageIndicator extends View implements PageIndicator {
    ...
    public TitlePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        final int defaultFooterIndicatorColor = res.getColor(R.color.default_title_indicator_footer_indicator_color);
        final int defaultFooterLineColor = res.getColor(R.color.default_title_indicator_footer_line_color);
        ...
        final int footerColorIndicator = a.getColor(R.styleable.TitlePageIndicator_footerColorIndicator, defaultFooterIndicatorColor);
        final int footerColorLine = a.getColor(R.styleable.TitlePageIndicator_footerColorLine, defaultFooterLineColor);
        mPaintText.setTextSize(textSize);
        mPaintText.setAntiAlias(true);
        mPaintFooterLine.setStyle(Paint.Style.FILL_AND_STROKE);
        mPaintFooterLine.setStrokeWidth(mFooterLineHeight);
        mPaintFooterLine.setColor(footerColorLine);
        mPaintFooterIndicator.setStyle(Paint.Style.FILL_AND_STROKE);
        mPaintFooterIndicator.setColor(footerColorIndicator);
    ...
    public void setFooterLineColor(int footerColor) {
        mPaintFooterLine.setColor(footerColor);
        invalidate();
    }

    public void setFooterIndicatorColor(int color) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        switch (mFooterIndicatorStyle) {
            ...
            case Underline:
                ...
                int footLineWidth = getResources().getDimensionPixelSize(R.dimen.foot_line_width);
                int centerPosition = (underlineBounds.right + underlineBounds.left) / 2;
                int startX = centerPosition - footLineWidth / 2;
                int endX = centerPosition + footLineWidth / 2;
...
//                mPath.lineTo(leftMinusPadding, heightMinusLineMinusIndicator);
                mPath.moveTo(startX, heightMinusLine);
                mPath.lineTo(endX, heightMinusLine);
                mPath.lineTo(endX, heightMinusLineMinusIndicator);
                mPath.lineTo(startX, heightMinusLineMinusIndicator);
                mPath.close();
