 ...
 */
package com.bobaoo.xiaobao.ui.widget.plaview;
...
public class XListView extends MultiColumnListView implements
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		default:
			...
			if (getFirstVisiblePosition() == 0) {
				...
				resetHeaderHeight();
			} else if (getLastVisiblePosition() + 4 >= mTotalItemCount) {
				// invoke load more.
				if (mEnablePullLoad) {
					startLoadMore();
				}
